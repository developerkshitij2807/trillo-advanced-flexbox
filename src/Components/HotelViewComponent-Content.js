  ...
  return (
    <main className='hotel-view'>
      <div className='gallery'>
        ...
        <figure className='gallery__item'>
          <img src='img/hotel-3.jpg' alt=' 3' className='gallery__photo' />
        </figure>
      </div>
        ...
        <div className='description'>
          ...
          <div className='recommend'>
            <p className='recommend__count'>
              Lucy and her 3 friends recommend this hotel.
            </p>
      ...
      <div className='cta'>
        ...
        <button className='btn'>
          <span className='btn__visible'>Book Now</span><span className='btn__invisible'>Only 4 rooms left</span>
        </button>
      </div>
    </main>
  );
